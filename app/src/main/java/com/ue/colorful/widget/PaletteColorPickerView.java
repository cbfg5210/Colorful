 ...
 */
public class PaletteColorPickerView extends View {
    ...
    private final int borderColor = 0xFFbdbdbd;
    ...
    public PaletteColorPickerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PaletteColorPickerView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        huePanelWidthPx = dpToPx(getContext(), HUE_PANEL_WDITH_DP);
        alphaPanelHeightPx = dpToPx(getContext(), ALPHA_PANEL_HEIGH_DP);
    ...
    private void initPaintTools() {
        ...
        satValTrackerPaint.setStrokeWidth(dpToPx(getContext(), 2));
        satValTrackerPaint.setAntiAlias(true);

        hueAlphaTrackerPaint.setColor(0xFF000000);
    ...
    private void drawSatValPanel(Canvas canvas) {
        ...
        canvas.drawCircle(p.x, p.y, circleTrackerRadiusPx - dpToPx(getContext(), 1), satValTrackerPaint);
