...
/**
 * Created by lazyeo on 8/15/16.
 */
public class RabbleView extends AppCompatTextView {
    //要擦拭的背景
    private Bitmap mBitmap;
    //擦拭背景颜色
    private int bgColor = 0XFF607D8B;
    //擦拭画布
    private Canvas mCanvas;
    //擦拭画笔
    private Paint mPaint;
    //擦拭画笔宽度
    private int mStrokeWidth = dip2px(getContext(), 40);
    //擦拭痕迹
    private Path mPath;
    private float mX, mY;
